...
- Кастомные блоки
  ...
  - можно взаимодействовать с ними (могут излучать свет, работать как сиденьи и менять внешний вид)
- Конвейер генерации кастомного контента (кастомные предметы, item model'ы, глифы, звуки, переводы, кастоим блоки и другие ассеты)
...
Также, вы можете получить модуль из вкладки [Releases](https://github.com/modoruru/hitori-resourcepack/releases) (если такие есть).
...
## Отдельное спасибо
[GSit](https://github.com/gecolay/GSit) - для референса логик поз (и некоторые части кода)